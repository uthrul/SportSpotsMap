        ...
        <View style={styles.header}>
          <View style={{ flex: 2, flexDirection: "row" }}>
            ...
            <View style={styles.options}>
              ...
              <Text style={{ fontSize: 14, fontWeight: "300" }}>Cibinong Spots Olahraga</Text>
            </View>
          </View>
          <View style={styles.settings}>
            <TouchableOpacity
  ...
  renderMap() {
    const campingMarker = ({ type }) => (
      <View style={[styles.marker, styles[`${type}Marker`]]}>
        {type === "rv" ? (
          <Ionicons name="md-football" color="red" size={28} />
        ) : (
          <Foundation name="trees" size={18} color="#FFF" />
        )}
      </View>
    );
